...
This document is no longer the active roadmap baseline.

Current planning authority lives in:

- `ROADMAP.md`
- `docs/superpowers/specs/2026-04-06-agent-os-reset-design.md`
- `docs/superpowers/plans/2026-04-06-agent-os-reset-plan.md`

Interpret the multi-frontend and productization material in this document as downstream work, not current implementation priority.

The active priority is to finish the Agent OS reset, close the graph-backed execution loop, and keep runtime truth boundaries clear before productization.
