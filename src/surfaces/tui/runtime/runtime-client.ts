/**
 * TUI surface 使用的 harness protocol client。
 *
 * 它负责：
 * - 通过 app server 请求 snapshot / commands / events
 * - 校验协议版本
 * - 为 TUI adapter 提供最小网络/传输访问层
 *
 * 注意：它不持有 thread 真相，也不实现 harness 逻辑。
 */
import type {
  RuntimeCommand,
  RuntimeEventEnvelope,
  RuntimeSnapshot,
} from "../../../harness/protocol/schemas/api-schema";
...
} from "../../../harness/protocol/schemas/protocol-version";
