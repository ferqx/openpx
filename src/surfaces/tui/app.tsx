/**
 * OpenPX 默认 TUI surface。
 *
 * 它消费 TUI kernel，负责交互、显示、输入导航、utility pane、
 * settings、streaming 会话展示与退出控制。
 *
 * 它不是 harness 本体，也不持有持久运行真相。
 */
import React, { useCallback, useEffect, useEffectEvent, useMemo, useRef, useState } from "react";
import { useInput } from "ink";
import {
  Screen,
  type ScreenChromeView,
  type ScreenComposerView,
  type ScreenConversationView,
  type ScreenUtilityView,
} from "./screen";
