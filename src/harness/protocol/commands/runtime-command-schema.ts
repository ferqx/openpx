...
export const runtimeCommandSchema = z.discriminatedUnion("kind", [
  ...
  z.object({
    kind: z.literal("agent_run_spawn"),
  ...
  z.object({ kind: z.literal("agent_run_inspect"), agentRunId: z.string().min(1) }),
  z.object({ kind: z.literal("agent_run_resume"), agentRunId: z.string().min(1) }),
  z.object({ kind: z.literal("agent_run_cancel"), agentRunId: z.string().min(1) }),
  z.object({ kind: z.literal("agent_run_join"), agentRunId: z.string().min(1) }),
  z.object({
